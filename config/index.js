export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx970c39ca907633d2",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c2ab778dfe38d57fcb42d1c8f20c3ab3",
   ...
   */
  USERS: [o2_VX63aAnI_LCmB_fBadNes6KNk
    {
      // 想要发送的人的名字
      name: "淇子",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "o2_VX63aAnI_LCmB_fBadNes6KNk",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "_0yolkhvV464Pw8PAgjSqyobNk0cGXNSF55uKwK0IUQ",
      // 所在省份
      province: "四川",
      // 所在城市
      city: "眉山",
